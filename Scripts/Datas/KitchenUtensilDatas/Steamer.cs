using UnityEngine;
public class Steamer : KitchenInteraction
{
    [SerializeField] bool needCustomedProgress;
    [SerializeField] float customedProgress;
    ...
    protected override void Initialize()
    {
        ...
        if (needCustomedProgress) maxProgress = customedProgress;
    }
